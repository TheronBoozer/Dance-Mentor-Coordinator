...
# set cron tasks
(crontab -l; echo "0 0 * * 6 sh ~/DMC_Bot/Launchers/Restart.sh >> ~/DMC_Bot/logs/restart.log") | crontab -        # restart at 00:00 Saturday
(crontab -l; echo "45 7 * * 6 sh ~/DMC_Bot/Launchers/Scrape.sh >> ~/DMC_Bot/logs/scrape.log") | crontab -         # Scrape info at 07:45 Saturday
(crontab -l; echo "0 8 * * 6 sh ~/DMC_Bot/Launchers/Initiate.sh >> ~/DMC_Bot/logs/initial.log") | crontab -       # Initialize at 08:00 Saturday
(crontab -l; echo "0 20 * * 7 sh ~/DMC_Bot/Launchers/Confirm.sh >> ~/DMC_Bot/logs/confirm.log") | crontab -       # Confirm at 20:00 Sunday
(crontab -l; echo "15 20 * * 7 sh ~/DMC_Bot/Launchers/Update.sh >> ~/DMC_Bot/logs/update.log") | crontab -        # Update at 20:15 Sunday
